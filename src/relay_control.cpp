...
uint32_t lastDebugTime_relay = 0;
...
void relaySetup()
{
    Serial.println("Relay Setup Start");
...
void relayLoop()
{
    ...
    // ===== DEBUG =====
    if (millis() - lastDebugTime_relay > 200)
    {
        lastDebugTime_relay = millis();

        Serial.print("[RELAY] CH6: ");
        Serial.print(ch6);
        Serial.print(" CH7: ");
        Serial.print(ch7);
        Serial.print(" CH8: ");
        ...
        Serial.print(" | Active: ");
        Serial.print(signalActive ? "YES" : "NO");
